...
export const CompanyService = new APIService('/actual_companies/', useMocks);
export const DailyCleaningReportsServiceETS = new APIService('/geozone_element_traveled_daily_report__ets/', useMocks);
export const DailyCleaningReportsServiceCAFAP = new APIService('/geozone_element_traveled_daily_report__cafap/', useMocks);
