          ...
          <Nav>
            ...
            <NavDropdown oneOfPermissions={[PERMISSIONS.report.list]} title="Отчеты" id="nav-dropdown-3">
              <NavDropdown title="Оперативные отчеты" id="nav-dropdown-3-1">
                ...
                <MenuItem active={path === '/brigade-efficiency-reports'} href="#/brigade-efficiency-reports">Работа бригад по ручной уборке</MenuItem>
            ...
            <NavItem permissions={[PERMISSIONS.administration]} title="Администрирование" href={`http://213.79.88.5/${process.env.STAND !== 'prod' ? 'ets-test/' : ''}admin`}><Glyphicon glyph="list-alt" /></NavItem>
          </Nav>
