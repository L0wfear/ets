...
import LeftPart from 'components/app_header/desktop/left/LeftPart';
import RightPart from 'components/app_header/desktop/right/RightPart';
import { DesktopContainer } from 'components/app_header/desktop/styled/index';
