...
import { dashBoardResetData } from 'components/dashboard/redux/modules/dashboard/actions-dashboard';
...
require('components/dashboard/menu/cards/DashboardMenuCards.scss');
