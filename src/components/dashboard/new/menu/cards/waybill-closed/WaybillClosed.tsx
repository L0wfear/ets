...
const mapStateToProps = (state) => ({
  isLoading: state.dashboard.waybill_closed.isLoading,
  title: state.dashboard.waybill_closed.data.title,
  items: state.dashboard.waybill_closed.data.items,
});
...
export default hocAll(
  withRequirePermissionsNew({
    permissions: 'dashboard.waybill_closed',
  }),
  connect(
    mapStateToProps,
    mapDispatchToProps,
