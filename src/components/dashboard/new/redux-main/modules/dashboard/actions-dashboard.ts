...
import * as defAns from 'components/dashboard/new/redux-main/modules/dashboard/mosk/defAns';
import {
  DASHBOARD_RESET,
  DASHBOARD_CHANGE_CART_DATA,
  DASHBOARD_CHANGE_IS_LOADING_IN_CART_DATA,
  DASHBOARD_SET_INFO_DATA,
} from 'components/dashboard/new/redux-main/modules/dashboard/dashboard';
...
import { CarInWorkOverallInfoDataType } from 'components/dashboard/new/redux-main/modules/dashboard/@types/car-in-work-overall.h';
import { FaxogrammsInfoDataType } from 'components/dashboard/new/redux-main/modules/dashboard/@types/faxogramms.h';
import { CurrentDutyMissionsItemsSubItemDatasType } from 'components/dashboard/new/redux-main/modules/dashboard/@types/current-duty-mission.h';
import { WaybillDraftInfoDataType } from 'components/dashboard/new/redux-main/modules/dashboard/@types/waibill-draft.h';
import { WaybillInProgressInfoDataType} from 'components/dashboard/new/redux-main/modules/dashboard/@types/waibill-in-progress.h';
import { WaybillCompletedInfoDataType } from 'components/dashboard/new/redux-main/modules/dashboard/@types/waibill-completed.h';
import { WaybillClosedInfoDataType } from 'components/dashboard/new/redux-main/modules/dashboard/@types/waibill-closed.h';
