...
import { componentsToDriver } from './component_to_select/index';
...
class MainInfoTab extends React.PureComponent<IPropsMainInfoTab, {}> {
  render() {
    const { props } = this;

    const car_drivers_primary_drivers = get(props.state, 'car_drivers_primary_drivers', []);
    const car_drivers_secondary_drivers = get(props.state, 'car_drivers_secondary_drivers', []);
