...
class BaseTechInspectionForm extends Form {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Modal id="modal-tech-inspection" show={this.props.show} onHide={this.props.onHide} backdrop="static">
...
export default BaseTechInspectionForm;
