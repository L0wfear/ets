...
class CleaningRateForm extends Form {
  render() {
    ...
    const TECHNICAL_OPERATIONS = technicalOperationsList.map(
    ...
    return (
      <Modal
        ...
        <Modal.Header closeButton>
          <Modal.Title>
            {!state.id ? 'Добавление' : 'Изменение'} показателя для расчета
            эффективности
          </Modal.Title>
        </Modal.Header>
        <ModalBody>
