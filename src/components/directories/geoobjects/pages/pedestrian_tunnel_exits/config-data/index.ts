...
import components from 'components/directories/geoobjects/pages/pedestrian_tunnel_exits/config-data/components';

export default {
  path: '/pedestrian-tunnel-exits',
  title: 'Справочник выходы из пешеходных тоннелей',
