...
export type StatePropsFuelRate = {
  ...
  companyStructureLinearOptions: ReturnType<
    typeof getCompanyStructureLinearOptions
  >;
...
export type DispatchPropsFuelRate = {
  actionGetAndSetInStoreSpecialModel: HandleThunkActionCreator<
    typeof someUniqActions.actionGetAndSetInStoreSpecialModel
  >;
  getAndSetInStoreCompanyStructureLinear: HandleThunkActionCreator<
    typeof companyStructureActions.getAndSetInStoreCompanyStructureLinear
  >;
  actionGetAndSetInStoreModelList: HandleThunkActionCreator<
    typeof someUniqActions.actionGetAndSetInStoreModelList
  >;
  fuelOperationsGetAndSetInStore: HandleThunkActionCreator<
    typeof fuelOperationsGetAndSetInStore
  >;
  actionResetModelList: HandleThunkActionCreator<
    typeof someUniqActions.actionResetModelList
  >;
  actionResetSpecialModel: HandleThunkActionCreator<
    typeof someUniqActions.actionResetSpecialModel
  >;
  resetSetCompanyStructureLinear: HandleThunkActionCreator<
    typeof companyStructureActions.resetSetCompanyStructureLinear
  >;
