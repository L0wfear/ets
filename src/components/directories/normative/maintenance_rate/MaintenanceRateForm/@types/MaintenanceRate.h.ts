...
export type DispatchPropsMaintenanceRate = {
  actionGetAndSetInStoreTechnicalOperationRegistry: HandleThunkActionCreator<typeof someUniqActions.actionGetAndSetInStoreTechnicalOperationRegistry>;
  actionResetTechnicalOperationRegistry: HandleThunkActionCreator<typeof someUniqActions.actionResetTechnicalOperationRegistry>;
  actionGetAndSetInStoreMaintenanceWork: HandleThunkActionCreator<typeof someUniqActions.actionGetAndSetInStoreMaintenanceWork>;
  actionResetMaintenanceWork: HandleThunkActionCreator<typeof someUniqActions.actionResetMaintenanceWork>;
  actionGetAndSetInStoreCleanCategories: HandleThunkActionCreator<typeof someUniqActions.actionGetAndSetInStoreCleanCategories>;
  actionResetCleanCategories: HandleThunkActionCreator<typeof someUniqActions.actionResetCleanCategories>;
};
