import { LayerSelectedGeooobjects } from 'components/map/new/layers/geoobjects/selected/LayerSelectedGeooobjects.h';
import { checkShowTrue, checkShowFalse } from 'components/map/new/layers/geoobjects/utils';
...
export const renderGeoobjects: LayerSelectedGeooobjects.renderGeoobjectsFunc = (selectedGeoobjects, new_selectedGeoobjects, thisProps) => {
  for (let serverName in new_selectedGeoobjects) {
