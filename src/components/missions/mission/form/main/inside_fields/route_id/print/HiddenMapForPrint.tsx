...
import { AbsoluteHiddenOverflow } from 'components/missions/mission/form/main/inside_fields/route_id/print/styled/styled';
import { Route } from 'redux-main/reducers/modules/routes/@types';

export interface IPropsHiddenMapForPrint {
  route: Route;
  hiddenMapConfig: {
    printMapKey: string;
    width: string;
