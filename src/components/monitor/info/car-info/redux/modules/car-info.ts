...
import { initialMaxSpeed } from 'components/monitor/info/car-info/redux/modules/constatnts';
...
export const CAR_INFO_SET_POPUP_PARKING_POINT = CAR_INFO`POPUP_PARKING_POINT`;
