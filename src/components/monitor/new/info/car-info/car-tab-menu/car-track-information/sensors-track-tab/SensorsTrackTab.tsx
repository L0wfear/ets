...
import SensorsEquipmentList from 'components/monitor/new/info/car-info/car-tab-menu/car-track-information/sensors-track-tab/equipment/SensorsEquipmentList'
import SensorsLevelList from 'components/monitor/new/info/car-info/car-tab-menu/car-track-information/sensors-track-tab/level/SensorsLevelList';

type PropsSensorsTrackTab = {
};

const SensorsTrackTab: React.SFC<PropsSensorsTrackTab> = () => (
