...
const InfoODh: React.SFC<any> = ({ data, ...props }) =>
  <div className="geoobject_one_data" onClick={props.centerOn}>
    <h5 className="title">
      <span>Наименование</span>
      <span className="car_info-close">
...
const InfoCarpool: React.SFC<any> = ({ data, ...props }) =>
  <div className="geoobject_one_data" onClick={props.centerOn}>
    <h5 className="title">
      <span>Наименование</span>
      <span className="car_info-close">
...
const InfoDangerZone: React.SFC<any> = ({ data, ...props }) =>
  <div className="geoobject_one_data" onClick={props.centerOn}>
    <h5 className="title">
      <span>Адрес</span>
      <span className="car_info-close">
...
const InfoPgm: React.SFC<any> = ({ data, ...props }) =>
  <div className="geoobject_one_data" onClick={props.centerOn}>
    <h5 className="title">
      <span>Наименование</span>
      <span className="car_info-close">
...
const InfoBridges: React.SFC<any> = ({ data, ...props }) =>
  <div className="geoobject_one_data" onClick={props.centerOn}>
    <h5 className="title">
      <span>Наименование</span>
      <span className="car_info-close">
...
const InfoPedestrianTunnels: React.SFC<any> = ({ data, ...props }) =>
  <div className="geoobject_one_data" onClick={props.centerOn}>
    <h5 className="title">
      <span>Наименование</span>
      <span className="car_info-close">
...
const InfoPedestrianTunnelExits: React.SFC<any> = ({ data, ...props }) =>
  <div className="geoobject_one_data" onClick={props.centerOn}>
    <h5 className="title">
      <span>Наименование</span>
      <span className="car_info-close">
...
const FountainsInfo: React.SFC<any> = ({ data, ...props }) =>
  <div className="geoobject_one_data" onClick={props.centerOn}>
    <h5 className="title">
      <span>Наименование</span>
      <span className="car_info-close">
...
export const InfoDefaultData: React.SFC<any> = ({ data, ...props }) => (
