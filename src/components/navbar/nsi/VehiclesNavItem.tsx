...
const VehicleNavItem: React.SFC<IPropsVehicleNavItem> = ({ path }) =>
  <NavDropdown oneOfPermissions={oneOfPermissions} title="Транспортные средства" id="nav-dropdown-2-1">
    ...
    <MenuItem permissions={['**.list']} active={path === '/tech-inspection'} href="#/tech-inspection">Техосмотр</MenuItem>
    <MenuItem permissions={['**.list']} active={path === '/insurance-policyn'} href="#/insurance-policy">Страховка</MenuItem>
  </NavDropdown>;
