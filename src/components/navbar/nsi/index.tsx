...
const NsiNavItem: React.SFC<IPropsNsiNavItem> = ({ path }) =>
  <NavDropdown oneOfPermissions={PERMISSIONS.nsi.list} title="НСИ" id="nav-dropdown-2">
    ...
    <MenuItem permissions={['faxogramm.list']} active={path.includes('/faxogramms')} href="#/faxogramms">Реестр централизованных заданий</MenuItem>
    ...
    <NavDropdown oneOfPermissions={[
      ...
      <MenuItem permissions={['ets_object_properties.list']} active={path === '/object-property-list'} href="#/object-property-list">Справочник характеристик объектов</MenuItem>
    </NavDropdown>
