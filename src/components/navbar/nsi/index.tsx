...
const NsiNavItem: React.SFC<IPropsNsiNavItem> = ({ path }) =>
  <NavDropdown id="show-nsi" oneOfPermissions={PERMISSIONS.nsi.list} title="НСИ" >
    ...
    >
      ...
      <MenuItem id="link-insurance-policyn" permissions={['autobase_insurance_policy.list']} active={path === '/insurance-policy'} href="#/insurance-policy">Реестр страховок</MenuItem>
