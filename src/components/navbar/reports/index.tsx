...
const ReportsNavItem: React.SFC<IPropsReportsNavItem> = ({ path }) =>
  <NavDropdown id="show-report" oneOfPermissions={PERMISSIONS.reportAll.list} title="Отчеты" >
    ...
    >
      ...
      <MenuItem id="link-car-downtime-and-overmileage-report" permissions={[PERMISSIONS.reportAll.car_downtime_and_overmileage_report.list]} active={path === '/car-downtime-and-overmileage-report'} href="#/car-downtime-and-overmileage-report">Простои и перепробеги ТС</MenuItem>
