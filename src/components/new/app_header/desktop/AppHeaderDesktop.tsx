...
import LeftPart from 'components/new/app_header/desktop/left/LeftPart';
import RightPart from 'components/new/app_header/desktop/right/RightPart';
import { DesktopContainer } from 'components/new/app_header/desktop/styled/index';
