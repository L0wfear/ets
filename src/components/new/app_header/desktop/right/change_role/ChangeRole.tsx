...
import CompanyOptionsNew from 'components/new/app_header/desktop/right/change_role/CompanyOptionsNew';
import { ChangeRoleContainer, CompanyOptionsNewContainer } from 'components/new/app_header/desktop/right/change_role/styled';
import {
  DivNone,
