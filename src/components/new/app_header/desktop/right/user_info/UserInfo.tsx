...
import { DefaultFirstDt } from 'components/new/app_header/styled';
import { connect } from 'react-redux';
import { ReduxState } from 'redux-main/@types/state';
import { getSessionState } from 'redux-main/reducers/selectors/index';
import { UserDataMenu, UserDataContainer, UserHeaderData, UserFio } from 'components/new/app_header/desktop/right/user_info/styled';
