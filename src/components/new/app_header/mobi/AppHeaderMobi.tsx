...
import { MobiContainer, FirstLvlMobi, SecondMenuContainerMobiFirst, ChangeRoleContainerWithButton, SecondMenuItemContainerMobi} from 'components/new/app_header/mobi/styled';
...
import BackToGorod from 'components/new/app_header/desktop/right/back_to_gorod/BackToGorod';
import ChangeRole from 'components/new/app_header/desktop/right/change_role/ChangeRole';
import UserInfo from 'components/new/app_header/desktop/right/user_info/UserInfo';
import EtsLogout from 'components/new/app_header/desktop/right/ets_logout/EtsLogout';
import docs from 'components/new/pages/doc_header/_config-data/index';

import OneMenuWrap from 'components/new/app_header/mobi/OneMenu';
