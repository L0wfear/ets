...
} from 'components/new/pages/inspection/common_components/add_inspect_employee/styled';
...
export type ViewAddInspectEmployeeProps = {
  ...
  selectedInspect: InspectAutobase | InspectPgmBase;
...
export type ViewAddInspectEmployeeInitialState = {
  resolve_to: any; // устранить до? date or string
...
const ViewAddInspectEmployee: React.FC<ViewAddInspectEmployeeProps> = (props) => {
  ...
  React.useEffect(
    () => {
      ...
      const closeEmployeeFio = props.selectedInspect.close_employee_fio
        ? props.selectedInspect.close_employee_fio
        : userData.fio;
      const closeEmployeePosition = props.selectedInspect.close_employee_position
        ? props.selectedInspect.close_employee_position
        : '-';
      const userMember = {
      ...
      const commission_members = props.selectedInspect.commission_members
