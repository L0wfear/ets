...
export const sparePartInfo: OneTabData = {
  title: 'Запчасти',
  tabKey: actualSparePartOnCarListConfig.item,
  component: actualSparePartOnCarListConfig.component,
  path: `/:${actualSparePartOnCarListConfig.id}?`,
  isRegistry: true,
};
