...
const Component = React.lazy(() => (
  import(/* webpackChunkName: "actual_batteries_on_car" */ 'components/new/pages/nsi/autobase/pages/car_actual/form/body_container/local_registry/actual_batteries_on_car/ActualBatteriesOnCarList')
));
