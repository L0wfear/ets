...
import RepairFormLazy from 'components/new/pages/nsi/autobase/pages/repair/form';

import {
  registryKey,
  getToConfig,
} from 'components/new/pages/nsi/autobase/pages/repair/_config-data/registry-config';
