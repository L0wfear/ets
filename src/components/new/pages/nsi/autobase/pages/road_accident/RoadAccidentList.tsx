...
import RoadAccidentFormLazy from 'components/new/pages/nsi/autobase/pages/road_accident/form';

import {
  registryKey,
  getToConfig,
} from 'components/new/pages/nsi/autobase/pages/road_accident/_config-data/registry-config';
