        ...
        <ModalBodyPreloader meta={meta} typePreloader="mainpage">
          ...
          <EtsBootstrap.Row>
            <EtsBootstrap.Col md={3}>
              <DefaultFieldString<Norm> formDataKey={formDataKey} fild_label="Наименование" field_name="name" disabled />
            </EtsBootstrap.Col>
            <EtsBootstrap.Col md={3}>
              <DefaultFieldString<Norm> formDataKey={formDataKey} fild_label="Элемент" field_name="elements_text" disabled />
            </EtsBootstrap.Col>
            <EtsBootstrap.Col md={3}>
              <DefaultFieldString<Norm> formDataKey={formDataKey} fild_label="Сезон" field_name="season_name" disabled />
            </EtsBootstrap.Col>
            <EtsBootstrap.Col md={3}>
              <DefaultFieldString<Norm> formDataKey={formDataKey} fild_label="Способ выполнения" field_name="kind_task_names" disabled />
            </EtsBootstrap.Col>
          </EtsBootstrap.Row>

          <EtsBootstrap.Row>
            <EtsBootstrap.Col md={3}>
              <DefaultFieldString<Norm> formDataKey={formDataKey} fild_label="Способ уборки" field_name="work_type_name" disabled />
            </EtsBootstrap.Col>
            <EtsBootstrap.Col md={3}>
              <DefaultFieldString<Norm> formDataKey={formDataKey} fild_label="Условия" field_name="conditions" disabled />
            </EtsBootstrap.Col>
            <EtsBootstrap.Col md={3}>
