...
type ButtonExportMissionArchieve = CommonTypesForButton & {};

const ButtonExportMissionArchieve: React.FC<ButtonExportMissionArchieve> = (props) => {
...
export default ButtonExportMissionArchieve;
