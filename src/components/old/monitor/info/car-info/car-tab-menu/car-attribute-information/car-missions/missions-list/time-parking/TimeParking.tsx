...
import { secondsToTime, makeUnixTimeMskTimezone } from 'components/@next/@utils/dates/dates';
...
class TimeParking extends React.PureComponent<PropsTimeParking, {}> {
  render() {
    ...
    const missionStart = makeUnixTimeMskTimezone(props.date_start);
    const missionEnd = makeUnixTimeMskTimezone(props.date_end);
