...
import LayerPolygonBuffer from 'components/old/monitor/layers/polygon_buffer/LayerPolygonBuffer';
import LayerMeasure from 'components/old/monitor/layers/measure/LayerMeasure';
