...
export const makeOptions = (carActualGpsNumberIndex: Record<string, Car>) => (
  Object.values(carActualGpsNumberIndex).reduce((newObj, { type_id, type_name, company_structure_id, company_structure_name, owner_id, owner_name, condition, condition_text, }) => {
    return {
      ...newObj,
