    ...
    return (
      <div className="date-table-input">
         <div className="pull-right">
          <ButtonToolbar>
            <Button onClick={this.handleAddVehicle}>{addButtonLabel}</Button>
            <Button disabled={this.state.selected === null} onClick={this.handleRemoveVehicle}>{removeButtonLable}</Button>
          </ButtonToolbar>
        </div>
        <DataTable
          title=""
