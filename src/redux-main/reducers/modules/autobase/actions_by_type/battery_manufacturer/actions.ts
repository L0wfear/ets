...
/* ---------- BatteryManufacturer ---------- */
export const autobaseSetBatteryManufacturer = (batteryManufacturerList: BatteryManufacturer[]): EtsAction<EtsActionReturnType<typeof autobaseSetNewData>> => (dispatch) => (
  dispatch(
    autobaseSetNewData({
