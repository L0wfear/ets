...
import { promiseGetPenaltyList, promiseUpdatePenalty } from 'redux-main/reducers/modules/autobase/actions_by_type/penalties/promise';
...
export const actionUpdatePenalty = (payload: Penalty, meta: LoadingMeta): EtsAction<EtsActionReturnType<typeof promiseUpdatePenalty>> => async (dispatch) => {
  return etsLoadingCounter(
    dispatch,
    promiseUpdatePenalty(payload),
    meta,
  );
};
