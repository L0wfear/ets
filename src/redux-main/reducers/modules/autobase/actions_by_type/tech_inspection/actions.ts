...
/* ---------- TechInspection ---------- */
export const autobaseSetTechInspection = (techInspectionList: TechInspection[]): EtsAction<EtsActionReturnType<typeof autobaseSetNewData>> => (dispatch) => (
  dispatch(
    autobaseSetNewData({
      techInspectionList,
    }),
...
export const autobaseRemoveTechInspection = (id: TechInspection['id'], meta: LoadingMeta): EtsAction<EtsActionReturnType<typeof updateSetTechInspection>> => async (dispatch) => {
  return etsLoadingCounter(
    dispatch,
