...
export const actionResetSetCompany = (): ThunkAction<null, ReduxState, {}, AnyAction> => (dispatch) => {
  dispatch(
    actionSetCompany([]),
  );
...
export const actionGetBlobCompany = (payloadOwn: object, meta: LoadingMeta): ThunkAction<ReturnType<typeof promiseLoadPFCompany>, ReduxState, {}, AnyAction> => async (dispatch) => {
...
export const actionLoadCompany = (payloadOwn: object, meta: LoadingMeta): ThunkAction<ReturnType<typeof promiseGetCompany>, ReduxState, {}, AnyAction> => async (dispatch) => {
  const { payload } = await dispatch({
    type: 'none',
...
export const actionUpdateCompany = (companyOld: Company, meta: LoadingMeta): ThunkAction<ReturnType<typeof promiseUpdateCompany>, ReduxState, {}, AnyAction> => async (dispatch) => {
  const { payload: company } = await dispatch({
    type: 'none',
...
export const actionRemoveCompany = (compnay_id: number, meta: LoadingMeta): ThunkAction<ReturnType<typeof promiseDeleteCompany>, ReduxState, {}, AnyAction> => async (dispatch) => {
